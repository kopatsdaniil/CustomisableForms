...
namespace CustomisableForms.Data.Migrations
{
    ...
    [Migration("20241023074528_AddFormsAndAnswersTables")]
    partial class AddFormsAndAnswersTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CustomisableForms.Models.Form", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CustomisableForms.Models.Form", b =>
                {
                    b.HasOne("CustomisableForms.Models.ApplicationUser", null)
                        .WithMany("Forms")
